...
namespace _Project.Scripts.Architecture.Services.Audio
{
    ...
    public class AudioConfig : ScriptableObject
    {
        ...
        [field: SerializeField, Range(0f, 2f)] public float AllyHitVolume { get; private set; } = 1f;
        [field: SerializeField] public AudioClip[] EnemyHitSounds { get; private set; }
        [field: SerializeField, Range(0f, 2f)] public float EnemyHitVolume { get; private set; } = 1f;
